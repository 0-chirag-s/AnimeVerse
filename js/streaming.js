...
function loadEpisodeDetail() {
    async function loadDetail() {
        ...
        document.title = `${episodeDetail['animenamewithep']} at animeverse`;
        ...
        animeTitle2.innerHTML = `<h1>${episodeDetail['animenamewithep']} at animeverse</h1>`;
        ...
        function animeDetails() {
            ...
            async function loadAnimeDetails() {
                ...
                function metaHeadTag() {
                    ...
                    ogtitle.setAttribute('content', `Watch ${episodeDetail['animenamewithep']} at animeverse`);
