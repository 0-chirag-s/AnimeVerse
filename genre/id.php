...
<head>
        ...
        <title>List genre <?=$id?> at animeverse</title>

        <meta name="robots" content="noodp, noydir" />
        <meta name="description" content="List genre <?=$id?> at animeverse">
        ...
        <meta property="og:title" content="List genre <?=$id?> at animeverse" />
        <meta property="og:description" content="List genre <?=$id?> at animeverse">
        ...
        <meta property="twitter:title" content="List genre <?=$id?> at animeverse" />
        <meta property="twitter:description" content="List genre <?=$id?> at animeverse" />
                                        ...
                                        <section class="content_left">
                                                ...
                                                <div class="main_body">
                                                        <div class="anime_name anime_movies">
                                                                ...
                                                                <div class="anime_name_pagination">
                                                                        <div class="pagination">
                                                                                <ul class='pagination-list'><?php $pagination = file_get_contents("$apiLink/genrePage?genre=$genre&page=$page");$pagination = json_decode($pagination, true); echo str_replace("active","selected",$pagination['pagination']) ?>
                                                        ...
                                                        <div class="last_episodes">
                                                                <ul class="items">
                                                                <?php
                                                                    $json = file_get_contents("$apiLink/genre/$genre?page=$page");
