...
<head>
    ...
    <title>List New Season Anime at animeverse</title>

    <meta name="robots" content="index, follow" />
    <meta name="description" content="List New Season Anime at animeverse">
    <meta name="keywords" content="List Winter , New Season">
    <meta itemprop="image" content="<?=$base_url?>/img/genkai.gif" />

    <meta property="og:site_name" content="animeverse" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="List New Season Anime at animeverse" />
    <meta property="og:description" content="List New Season Anime at animeverse">
    ...
    <meta property="twitter:title" content="List New Season Anime at animeverse" />
    <meta property="twitter:description" content="List New Season Anime at animeverse" />
                ...
                <section class="content">
                    <section class="content_left">
                        ...
                        <div class="main_body">
                            <div class="anime_name new_series">
                                ...
                                <div class="anime_name_pagination">
                                    <div class="pagination">
                                        <ul class='pagination-list'><?php $pagination = file_get_contents("$apiLink/newSeasonPage?page=$page");$pagination = json_decode($pagination, true); echo str_replace("active","selected",$pagination['pagination']) ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="items">
                               <?php
                                   $json = file_get_contents("$apiLink/new-season?page=$page");
