...
<head>
        ...
        <title>List completed Anime at animeverse</title>

        <meta name="robots" content="index, follow" />
        <meta name="description" content="List completed Anime at animeverse">
        ...
        <meta property="og:title" content="List completed Anime at animeverse" />
        <meta property="og:description" content="List completed Anime at animeverse">
        ...
        <meta property="twitter:title" content="List completed Anime at animeverse" />
        <meta property="twitter:description" content="List completed Anime at animeverse" />
                                        ...
                                        <section class="content_left">
                                                ...
                                                <div class="main_body">
                                                        <div class="anime_name anime_movies">
                                                                ...
                                                                <div class="anime_name_pagination">
                                                                        <div class="pagination">
                                                                                <ul class='pagination-list'><?php $pagination = file_get_contents("$apiLink/completedPage?page=$page");$pagination = json_decode($pagination, true); echo str_replace("active","selected",$pagination['pagination']) ?>
                                                        ...
                                                        <div class="last_episodes">
                                                                <ul class="items">
                                                                <?php
                                                                    $json = file_get_contents("$apiLink/completed-anime?page=$page");
