        <header>
           ...
           <div class="change">
            <form action="">
              ...
              <!-- <i class="icongec-login new_icon "></i> -->
                <!-- <a href="/register.html" class="new_signin"><p class="abc">sigin</P></a>
                <a href="/login.html" class="cda "><p class="abc">  login </P></a>
              -->
            </form>
           </div>
            ...
            <a class="btn twitter hidden-phone" href="https://x.com/Ani_me_Verse" target="_blank"
                data-url=""></a>
             
              <a class="btn facebook hidden-phone" href="https://www.facebook.com/Ani.meVerse.0012/"
                target="_blank"></a>
              <a class="btn discord hidden-phone" style="margin-right:5px;" href="https://discord.com/invite/ZENSpKrpja"
                target="_blank" data-url=""></a>
              <a class="btn telegram hidden-phone" style="margin-right:5px;"
                href="https://t.me/chirag_s01" target="_blank" data-url=""></a>
          ...
          <section class="headnav">
            ...
            <div class="headnav_left">
              <a href="/"><img src="<?=$base_url?>/img/genkai.gif" class="download show ads-evt"
                  alt="animeverse - Watch Anime Online" /></a>
            </div>
              ...
              <nav class="menu_top">
                <ul>
                  ...
                  <li class="seri "><a href="<?=$base_url?>/new-season" title="New season"
                      class="series ads-evt">New season</a></li>
                  <li class="movies "><a href="<?=$base_url?>/anime-movies" title="Movies"
                      class="movie ads-evt">Movies</a></li>
                  <li class="movies "><a href="<?=$base_url?>/popular" title="Popular"
                      class="popular ads-evt">Popular</a></li>
                      <li class="movies "><a href="<?=$base_url?>/aboutus" title="About-Us"
                      class="popular ads-evt">About-Us</a></li>
